...
- Ak vytvárate novú šablónu, musíte pridať tento stĺpec. V Power Query vyberte **Pridajte podmienený stĺpec** a zadajte názov nového stĺpca, napríklad **ModelID**. Zadajte podmienku pre stĺpec, kde, ak projektová úloha nemá hodnotu null, potom \<zadajte ID predpovedného modelu\>; inak null.
...
[![Mapovanie šablón](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- Ak vytvárate novú šablónu, musíte pridať tento stĺpec. V Power Query vyberte **Pridajte podmienený stĺpec** a zadajte názov nového stĺpca, napríklad **ModelID**. Zadajte podmienku pre stĺpec, kde, ak ID riadka odhadu nemá hodnotu null, potom \<zadajte ID predpovedného modelu\>; inak null.
...
[![Mapovanie šablón](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![Mapovanie šablón](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)

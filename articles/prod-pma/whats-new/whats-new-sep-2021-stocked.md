...
| Projektový manažment a účtovníctvo | [537214](https://fix.lcs.dynamics.com/Issue/Details/?bugId=537214) | Problém so zaokrúhľovaním dane z pridanej hodnoty (DPH) nastane, keď je dobropis vyrovnaný oproti pôvodnej projektovej faktúre. |
...
| Projektový manažment a účtovníctvo | [574162](https://fix.lcs.dynamics.com/Issue/Details/?bugId=574162) | The **Oprava/Storno faktúry** sekcia na faktúre s voľným textom zmizne po výbere ID projektu. |
...
| Projektový manažment a účtovníctvo | [588714](https://fix.lcs.dynamics.com/Issue/Details/?bugId=588714) | Vyskytol sa problém s výkonom, keď sa návrh projektovej faktúry zaúčtuje v dávkovom režime z dôvodu spojenia s **General JournalAccountEntry**. |
...
| Projektový manažment a účtovníctvo | [593663](https://fix.lcs.dynamics.com/Issue/Details/?bugId=593663) | Šablónu ponuky projektu Excel nie je možné pridať do súboru **Otvorte v Exceli** Ponuka. |
...
| Projektový manažment a účtovníctvo | [598688](https://fix.lcs.dynamics.com/Issue/Details/?bugId=598688) | **TimeEntryDataManager** spôsobí, že mobilná aplikácia Project timesheet pre Android prestane reagovať. |
...
| Cestovanie a výdavky | [569458](https://fix.lcs.dynamics.com/Issue/Details/?bugId=569458) | The **Priložené účtenky** pole je nastavené na **Áno** a to aj v prípade, že k výdavkovému riadku nie je priložený žiadny doklad. |
...
| Cestovanie a výdavky | [586081](https://fix.lcs.dynamics.com/Issue/Details/?bugId=586081) | Stav schválenia hlavného riadku výdavkov sa nesynchronizuje so stavom schválenia pracovného toku rozpísaného riadku. |

...
description: Tento článok poskytuje príklady projektových zmlúv, ktoré môžete vytvoriť pre rôzne typy projektov a zdrojov financovania, a ako môžete spravovať zmluvy a fakturovať zákazníkom projektu.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''

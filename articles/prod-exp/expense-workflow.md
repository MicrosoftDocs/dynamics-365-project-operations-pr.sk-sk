...
description: Tento článok vysvetľuje, ako môžete použiť systém pracovného toku v Microsoft Dynamics 365 Financie, aby ste nastavili proces kontroly pre výkazy výdavkov v riadení výdavkov.

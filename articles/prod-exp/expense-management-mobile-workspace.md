...
- Odfoťte účtenku a nahrajte ju na Dynamics 365 Finance. Túto fotografiu môžete neskôr priložiť k výkazu výdavkov.
...
Ak bola pre vašu organizáciu nasadená služba Finance, správca systému musí zverejniť mobilný pracovný priestor **Správa výdavkov**. Pokyny nájdete v časti [Zverejnenie mobilných pracovných priestorov](/dynamics365/fin-ops-core/dev-itpro/mobile-apps/publish-mobile-workspace).
...
<ol>
<li><a href="/dynamics365/fin-ops-core/dev-itpro/migration-upgrade/install-metadata-hotfix-package#download-the-hotfix-from-lcs">Prevziať si rýchlu opravu metadát z Microsoft Dynamics Lifecycle Services (LCS)</a>.</li>
<li><a href="/dynamics365/fin-ops-core/dev-itpro/migration-upgrade/install-metadata-hotfix-package#install-the-metadata-hotfix-package">Nainštalovať rýchlu opravu metadát</a>.</li>

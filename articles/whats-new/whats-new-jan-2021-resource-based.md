...
description: Tento článok poskytuje informácie o aktualizáciách kvality dostupných vo vydaní Project Operations z januára 2021 pre scenáre založené na zdrojoch alebo bez zásob.
author: sigitac
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''

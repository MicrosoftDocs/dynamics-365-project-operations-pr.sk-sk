...
description: Tento článok poskytuje informácie o aktualizáciách kvality, ktoré sú k dispozícii vo vydaní nasadenia Project Operations pre scenáre založené na zdrojoch/neskladovaných položkách z júna 2021.
author: sigitac
ms.date: 06/14/2021
ms.topic: article
ms.prod: ''
...
- Projektový manažment a účtovníctvo v prostrediach aplikácií na riadenie financií a prevádzok verzie 10.0.19.

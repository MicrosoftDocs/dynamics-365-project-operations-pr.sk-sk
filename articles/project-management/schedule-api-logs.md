...
- Použite kód Service SDK, ktorý používa Xrm SDK **updateRecord** metóda (referencia API klienta) v aplikáciách riadených modelom. Power Apps obsahuje popis a podporované parametre pre **updateRecord** metóda.

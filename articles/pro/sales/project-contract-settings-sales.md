---
title: Podrobnosti hlavičky pre projektové zmluvy
description: Tento článok poskytuje informácie o poliach a informácie o projektových zmluvách v Project Operations.
author: rumant
ms.date: 03/08/2022
ms.topic: article
...
| Zaznamenané množstvo | Detail riadka na základe projektu | Čas: Množstvo celkových časových nákladov pre rolu v projekte, ktorá je priradená k tomuto riadku zmluvy. Výdavky: Všetky množstvá pre túto kategóriu výdavkov pre skutočnú hodnotu výdavkov v projekte, ktorý je priradený k tomuto riadku zmluvy. |

...
---
# <a name="creating-invoice-schedules-on-a-project-based-contract-line"></a>Vytvorenie plánov faktúr v riadku zmluvy na základe projektu
...
Keď má riadok zmluvy pevný spôsob fakturácie, môžete vytvoriť plán fakturácie na základe medzníka. Vykonaním nasledujúcich krokov vygenerujete plán fakturácie na základe medzníka pre pevne nastavené alebo rovnomerne rozložené medzníky pre kalendárne obdobie.
...
| Suma riadka | Rýchle vytvorenie | Suma alebo hodnota medzníka, ktorá bude fakturovaná zákazníkovi | Prenesie sa na medzník projektového riadka zmluvy a na faktúru | | Daň | Rýchle vytvorenie | Výška dane, ktorá sa použije na dosiahnutie medzníka | Prenesie sa na medzník projektového riadka zmluvy a na faktúru |
